...
all: build/duktape build/repl build/dump_load build/dump_bytecode build/dump_load_nocleanup
...
clean:
	rm -rf build/*.o build/duktape build/repl build/dump_load build/dump_bytecode build/dump_load_nocleanup
